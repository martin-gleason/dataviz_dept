...
```{r yasi_risk, include=TRUE, echo=FALSE, message = FALSE}
...
cal_57 %>%
  ...
  kable(booktabs = TRUE, format = "html", caption = "Case Totals, Lawndale and GBO: September, 2018") %>%
...
---
```{r initial_graphs, include = TRUE, echo = FALSE, dpi = 300, fig.cap= "GBO and Lawndale, September 2018", fig.align='center', fig.retina=1, out.width='85%', out.height='85%'}
...
---
```{r, markham_north, include = TRUE, echo = TRUE, fig.cap = "Socials and VOPs in Markham North", fig.align='center', fig.pos = "h"}
