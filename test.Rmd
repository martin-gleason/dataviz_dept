...
.pull-left[![:scale 55%](imgs/rick_right.jpg)]
...
```{r 12_19, echo=, warning=TRUE, include=TRUE}
...
<!-- .center[![:scale 75%](imgs/tidy_data1.png)] -->
...
<!--   kable(booktabs = TRUE, format = "html", caption = "GBO and Lawndale by High Risk: September, 2018") %>% -->
<!--   kable_styling(bootstrap_options = c("condensed", "hover"), font_size = 16) %>% -->
<!--   scroll_box(width = "720px", height = "425px") -->
